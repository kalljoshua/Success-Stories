...
@section('title')
    <title>Success Stories Africa : Stories</title>
@endsection
                    ...
                    <table class="table table-striped custom-table datatable">
                        ...
                        <tr>
                            ...
                            <td style="text-transform: lowercase">
                                <!-- Rounded switch -->
                                <label class="switch">
                                    <input type="checkbox" id="rec-check-story{{$story->id}}"
                                           data-property-id="{{$story->id}}"
                                           onchange="trendstory({{$story->id}});">
                                ...
                                <div class="modal-content modal-lg">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('admin.story.edit')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <input type="text" value="{{$story->author}}" name="author" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="form-group ">
